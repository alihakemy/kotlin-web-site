...
* See how [different companies](https://kotlinlang.org/lp/mobile/case-studies) are already using Kotlin for
  cross-platform app development in production.
* Share UIs between Android and iOS with [Compose for iOS](https://github.com/JetBrains/compose-multiplatform-ios-android-template/#readme). 
...
> To learn about the full capabilities of the technology, check out [other use cases](multiplatform.md#multiplatform-libraries).
>
{type="tip"}
